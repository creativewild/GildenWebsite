<?php
   ...
   ***************************/
	...
	if ($_SESSION['User_ID'] == 2)
	{
		...
		if ($Statusserver == "UP")
		{
			$Serverbild = "./img/site/Glasbutton_Gr�n.png";
			
		}
		else
		{
			$Serverbild = "./img/site/Glasbutton_Rot.png.jpg";
			$Population = "";
		}
	}
		...
		<ul>
			 ...
			 <li><a href="#">Media</a>
				<ul>
					...
					<li><a href="https://www.facebook.com/groups/515150171884119/" onclick="FensterOeffnen(this.href); return false">Facebook</a></li>					
			...
			<div id="page-bgbtm">
				...
				<div id="sidebar">
					<ul>
						...
						<li>
							...
							<?php
								...
								{	
									...
									$arrayuser=explode(".", $datum_de);
									if ($row['GebDatum']!= "1970-01-01")
									{
										if($arrayuser[0]==$arraydate[0])
										{

											if($arrayuser[1]==$arraydate[1])
											{

												$jetzt = mktime(0, 0, 0, $arraydate[1],$arraydate[0], $arraydate[2]); 
												$gebur = mktime(0, 0, 0, $arrayuser[1], $arrayuser[0], $arrayuser[2]); 
												$age   = intval(($jetzt - $gebur) / (3600 * 24 * 365));
												if($Geburtstag)
												{
													echo '<h2>Geburtstag</h2>';
													echo '<div id="gebgif"><img src="./img/site/neuBewerberForum.gif" width="100" height="auto" /></div>';
												}
												echo '<h4>'.$row["Mainchar"].'</h4>';
												$i++;
											}
										}
									}
						...
						?>
						<li>
							<div class="sidebar_ts" style="margin-top: 10px;">
								<div id="TS3">
